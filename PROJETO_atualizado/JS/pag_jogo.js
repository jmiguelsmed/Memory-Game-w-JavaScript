...
function Classico(jogador, pontos, tentativas, pontuacaoFinal) {
...
function trataNovoClassico() {
    ...
    let novoClassico = new Classico(jogador, pontos, tentativas, pontuacaoFinal);

    gravaClassicoHistorico(novoClassico);
}

function gravaClassicoHistorico(classico) {
    
    classicoArray.push(classico);
    gravaHistoricoClassico();
}

function gravaHistoricoClassico() {
    
    let classicoJSON = JSON.stringify(classicoArray);

    
    localStorage.setItem('classicoData', classicoJSON);
}
